...
for eps_scale in np.linspace(2.0e-4, 2.4e-3, 8):
    ...
    for _ in range(50):                                        # staggered loop
        ...
        eps, sigma, delta, it_mech, conv = solve_elastic(
        ...
        d_st, it_helm, conv_helm = solve_helmholtz_cg(
...
step 1/8  eps11=2.00e-04  sigma11_ave=  4.2725 MPa  max(d)=0.9000  staggered_iters= 2  mech_cg=  67  helm_cg=  3
step 2/8  eps11=5.14e-04  sigma11_ave= 10.4737 MPa  max(d)=0.9000  staggered_iters= 2  mech_cg=  64  helm_cg=  3
step 3/8  eps11=8.29e-04  sigma11_ave= 15.4583 MPa  max(d)=0.9000  staggered_iters= 3  mech_cg=  63  helm_cg=  3
step 4/8  eps11=1.14e-03  sigma11_ave= 18.8560 MPa  max(d)=0.9000  staggered_iters= 4  mech_cg=  61  helm_cg=  4
step 5/8  eps11=1.46e-03  sigma11_ave= 20.5955 MPa  max(d)=0.9000  staggered_iters= 5  mech_cg=  59  helm_cg=  4
step 6/8  eps11=1.77e-03  sigma11_ave= 20.6374 MPa  max(d)=0.9000  staggered_iters= 9  mech_cg=  57  helm_cg=  5
step 7/8  eps11=2.09e-03  sigma11_ave=  0.0975 MPa  max(d)=0.9946  staggered_iters=39  mech_cg= 408  helm_cg= 14
step 8/8  eps11=2.40e-03  sigma11_ave=  0.0589 MPa  max(d)=0.9959  staggered_iters= 4  mech_cg= 624  helm_cg= 16
...
[`docs/examples_src/pff_damage.py`](https://github.com/choROPeNt/FFTjax/blob/main/docs/examples_src/pff_damage.py):

```bash
python docs/examples_src/pff_damage.py
```
