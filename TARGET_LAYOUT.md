...
│
├── post/                          # post-processing and field-data output
│   ├── io.py                      ✅ IncrementalWriter — project-wide standard for XDMF/HDF5 output
│   └── fields.py                  ✅ field_to_grid, von_mises, compute_displacement
│
├── utils/
│   ├── io/
│   │   ├── xdmf_writer.py         # incremental HDF5 + growing .xdmf temporal index — planned move of post/io.py
