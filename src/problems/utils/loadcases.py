...
Shared by scripts/simulation/solve_mechanics.py and solve_inelastic.py so a
driver can run many load cases on one microstructure from one config and one
